...
use crate::{
    dto::{
        ...
        CreateFolderRequest, CreatePersonalAccessTokenRequest, CreateProviderImportJobRequest,
        CreateProviderImportPlanRequest, CreateSubscriptionAccessTokenRequest,
        ...
        OidcLoginStartResponse, OidcProviderResponse, PackTagResponse, PatScopePolicyResponse,
        PersonalAccessTokenResponse, ProviderConfigResponse, ProviderHttpHeaderResponse,
        ProviderHttpRequestPlanResponse, ProviderImportJobEventResponse, ProviderImportJobResponse,
        ProviderImportPlanResponse, RegisterLocalUserRequest, SubscriptionAccessResourceTypeDto,
        SubscriptionAccessTokenResponse, SubscriptionGroupPackResponse, SubscriptionGroupResponse,
        TagResponse, TelegramExportJobOptions, TelegramPublicationResponse,
        TelegramReconcileModeOption, TenantMemberResponse, TenantRoleResponse,
        TenantSettingsResponse, TenantUserResponse, UpdateExportTargetRequest, UpdatePackRequest,
        UpdateTenantSettingsRequest, UpdateTenantUserStatusRequest, UpsertOidcProviderRequest,
        UpsertPackMembershipRequest, UpsertProviderConfigRequest, UpsertTenantMemberRequest,
        UpsertTenantRoleRequest,
    },
    error::ApiErrorBody,
    routes::{
        assets, auth, exports, health, metadata, packs, pats, provider_configs, provider_imports,
...
#[openapi(
    paths(
        ...
        provider_configs::upsert_provider_config,
        provider_configs::delete_provider_config,
        provider_imports::create_provider_import_job,
        provider_imports::get_provider_import_job,
        provider_imports::list_provider_import_job_events,
        packs::list_packs,
        packs::update_pack,
        packs::delete_pack,
        packs::export_pack,
    ...
    components(schemas(
        ...
        CreateProviderImportJobRequest,
        ProviderImportJobResponse,
        ProviderImportJobEventResponse,
        UpdatePackRequest,
        CreateFolderRequest,
        FolderResponse,
