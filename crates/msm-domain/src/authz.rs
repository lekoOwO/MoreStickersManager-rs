...
impl Permission {
    ...
    pub fn as_key(self) -> &'static str {
        match self {
            ...
            Self::TenantManageUsers => "tenant.manage_users",
            Self::TenantManageRoles => "tenant.manage_roles",
            ...
            Self::ExportTargetManage => "export.target.manage",
    ...
    pub fn from_key(key: &str) -> Option<Self> {
        match key {
            ...
            "tenant.manage_users" => Some(Self::TenantManageUsers),
            "tenant.manage_roles" => Some(Self::TenantManageRoles),
            ...
            "export.read" => Some(Self::ExportRead),
            "export.run" => Some(Self::ExportRun),
            "export.target.manage" => Some(Self::ExportTargetManage),
