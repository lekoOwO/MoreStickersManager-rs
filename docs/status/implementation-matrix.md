...
| MCP endpoint | Implemented | `/mcp` supports JSON-RPC initialize, ping, tools/list, pack list/export/import/update/delete tools, folder/tag/subscription-group create/list tools, export target/job tools, and Telegram publication history read tools. |
...
| Folder/tag management | Next phase | Database tables, storage repository primitives, protected API routes, OpenAPI schemas, CLI commands, MCP tools, and Web create/list management UI exist for folder create/list and tag create/list. Storage, API, and CLI primitives exist for pack-folder and pack-tag links; MCP/Web membership controls remain later work. |
| Subscription groups | Next phase | Domain/storage foundations, repository primitives, protected API routes, OpenAPI schemas, CLI commands, MCP tools, and Web create/list management UI exist for subscription group create/list. Storage, API, and CLI primitives exist for subscription group pack links; MCP/Web membership controls, subscription links, and moreStickers auto-update integration remain later work. |
...
Expand product-data membership operations into MCP and Web surfaces, then continue pack and subscription-group access-management APIs beyond membership links.
