...
| Folder/tag management | Next phase | Database tables exist; management APIs are planned in `docs/superpowers/plans/2026-05-09-msm-product-data-api.md`. |
| Subscription groups | Next phase | Domain/storage foundations exist; management APIs are planned in `docs/superpowers/plans/2026-05-09-msm-product-data-api.md`. Pack/group subscription links and moreStickers auto-update integration remain later work. |
