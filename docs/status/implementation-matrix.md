...
| Subscription payload contract | Next phase | Domain helpers can build MoreStickers dynamic pack-set metadata for public or protected subscription links. API endpoints and link rotation controls remain later work. |
