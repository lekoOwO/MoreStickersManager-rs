...
| Folder/tag management | Next phase | Database tables, storage repository primitives, protected API routes, and OpenAPI schemas exist for folder create/list and tag create/list. CLI/MCP/Web management surfaces are not implemented. |
| Subscription groups | Next phase | Domain/storage foundations, repository primitives, protected API routes, and OpenAPI schemas exist for subscription group create/list. Pack membership management, subscription links, CLI/MCP/Web surfaces, and moreStickers auto-update integration remain later work. |
...
Continue with CLI/MCP or Web surfaces for folder, tag, and subscription group metadata, then expand pack access-management APIs beyond basic visibility.
