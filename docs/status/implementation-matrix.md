...
Continue by hardening destructive mirror operator documentation, then start the next data-management slice for folders, tags, subscription groups, and pack access control.
