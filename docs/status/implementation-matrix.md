...
| Asset privacy enforcement | Future phase | Private pack asset paths reject anonymous reads and accept owner `asset.read` PATs, pack subscription tokens, or subscription-group tokens containing the pack. Web-session asset access remains incomplete. |
...
Continue with subscription link generation, subscription payload contracts, and pack/subscription-group access-management APIs beyond membership links.
