...
Continue by adding API/OpenAPI examples or typed option documentation for Telegram reconciliation options, then start the next data-management slice for folders, tags, subscription groups, and pack access control.
