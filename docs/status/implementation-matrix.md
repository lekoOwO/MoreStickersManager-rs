...
| Folder/tag management | Next phase | Database tables, storage repository primitives, protected API routes, OpenAPI schemas, and CLI create/list commands exist for folder create/list and tag create/list. MCP/Web management surfaces are not implemented. |
| Subscription groups | Next phase | Domain/storage foundations, repository primitives, protected API routes, OpenAPI schemas, and CLI create/list commands exist for subscription group create/list. Pack membership management, subscription links, MCP/Web surfaces, and moreStickers auto-update integration remain later work. |
...
Continue with MCP or Web surfaces for folder, tag, and subscription group metadata, then expand pack access-management APIs beyond basic visibility.
