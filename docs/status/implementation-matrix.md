...
| Folder/tag management | Next phase | Database tables and storage repository primitives exist for folder CRUD/listing and tag create/list/delete. Management APIs are planned in `docs/superpowers/plans/2026-05-09-msm-product-data-api.md`. |
| Subscription groups | Next phase | Domain/storage foundations and repository list/rename/delete primitives exist. Management APIs are planned in `docs/superpowers/plans/2026-05-09-msm-product-data-api.md`. Pack/group subscription links and moreStickers auto-update integration remain later work. |
...
Continue with the product-data API slice for folders, tags, subscription groups, and pack access control.
