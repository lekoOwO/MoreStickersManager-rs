...
| CLI | Implemented | `msm-cli` supports health, pack list/import/export/rename/delete, PAT create/list/revoke, folder/tag/subscription-group create/list, export target kinds, export target list/create, export job create/get/events, Telegram publication history list/get, and Bearer PAT forwarding. |
...
| Folder/tag management | Next phase | Database tables, storage repository primitives, protected API routes, OpenAPI schemas, CLI commands, MCP tools, and Web create/list management UI exist for folder create/list and tag create/list. Storage and API primitives exist for pack-folder and pack-tag links; CLI/MCP/Web membership controls remain later work. |
| Subscription groups | Next phase | Domain/storage foundations, repository primitives, protected API routes, OpenAPI schemas, CLI commands, MCP tools, and Web create/list management UI exist for subscription group create/list. Storage and API primitives exist for subscription group pack links; CLI/MCP/Web membership controls, subscription links, and moreStickers auto-update integration remain later work. |
...
Expand product-data membership operations into CLI, MCP, and Web surfaces, then continue pack and subscription-group access-management APIs beyond membership links.
